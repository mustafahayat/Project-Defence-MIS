...
namespace Project_MIS.Areas.Admin.Controllers
{
    ...
    public class UniversitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id")] University university)
        {
            if (id != university.Id)
            {
                return NotFound();
